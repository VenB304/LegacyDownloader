...
- **Требования** — проверяет, установлено ли дополнительное ПО, которое нужно Legacy (Kinect SDK, среды выполнения Visual C++), и позволяет установить недостающее.

![Диалог требований к ПО](images/07-requirements-ru.png)

## 4. Выбор отдельных песен
...
## 7. Возвращение позже за новыми песнями
